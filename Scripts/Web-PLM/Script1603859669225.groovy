...
WebUI.click(findTestObject('Object Repository/Page_3DEXPERIENCE Platform/span_Manage_ds-coachmark-close'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_3DEXPERIENCE Platform/span_PLM ADM'), 0)
